...
$FG_TABLE_HEAD_COLOR = "#4E5765";


$FG_TABLE_EXTERN_COLOR = "#A6AA68"; //#CC0033 (Rouge)
$FG_TABLE_INTERN_COLOR = "#FFFFDF"; //#FFEAFF (Rose)
...
$FG_TABLE_ALTERNATE_ROW_COLOR[] = "#ECECE9";
...
$FG_TABLE_COL[]=array ("Fecha", "calldate", "17%", "center", "SORT", "19");
//$FG_TABLE_COL[]=array ("Canal", "channel", "10%", "center", "", "30", "", "", "", "", "", "display_acronym");
$FG_TABLE_COL[]=array ("Fuente", "src", "11%", "center", "", "30");
$FG_TABLE_COL[]=array ("Clid", "clid", "16%", "left", "", "20");
//$FG_TABLE_COL[]=array ("Lastapp", "lastapp", "7%", "center", "", "30");

//$FG_TABLE_COL[]=array ("Ultima data", "lastdata", "12%", "center", "", "30");
...
$FG_TABLE_COL[]=array ("Disposición", "disposition", "11%", "center", "", "30");
$FG_TABLE_COL[]=array ("Contexto", "dcontext", "9%", "left", "SORT", "12");
$FG_TABLE_COL[]=array ("Agente", "dstchannel", "9%", "left", "SORT", "12");
if ((!isset($resulttype)) || ($resulttype=="min")) $minute_function= "display_minute";
$FG_TABLE_COL[]=array ("Duración", "duration", "8%", "center", "SORT", "20", "", "", "", "", "", "$minute_function");

if ((!isset($resulttype)) || ($resulttype=="min")) $minute_function= "display_minute";
$FG_TABLE_COL[]=array ("Billsec", "billsec", "6%", "center", "SORT", "30", "", "", "", "", "", "$minute_function");
$FG_TABLE_COL[]=array ("Audio", "userfield", "18%", "center", "", "25");
//$FG_TABLE_COL[]=array ("Userfield", "userfield", "8%", "center", "", "20");
$FG_TABLE_COL[]=array ("", "userfield", "1%", "center", "", "20");
...
//$FG_COL_QUERY='calldate, channel, src, clid, lastapp, lastdata, dst, dst, disposition, duration, billsec, accountcode';
//$FG_COL_QUERY='calldate, channel, src, clid, lastdata, dst, disposition, duration, billsec, uniqueid';
$FG_COL_QUERY='calldate, src, clid, dst, disposition, dcontext, dstchannel, duration, billsec, userfield, userfield';
...
$FG_HTML_TABLE_TITLE=" Registro de Llamadas";
...
if ($posted==1){
  ...
  $SQLcmd = do_field($SQLcmd, 'dcontext');
...
<!-- ** ** ** ** ** Part for the research ** ** ** ** ** -->
	<FORM style="display:inline" METHOD="POST" ACTION="<?php echo $PHP_SELF?>?s=<?php echo $s?>&t=<?php echo $t?>&order=<?php echo $order?>&sens=<?php echo $sens?>&current_page=<?php echo $current_page?>" style="position: relative; top:-.1em">
	<INPUT TYPE="hidden" NAME="posted" value=1>
	<INPUT TYPE="hidden" NAME="current_page" value=0>	
		<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" style="border: 1px solid #9D9D59">
			<tbody>
			
			<tr>
        		<td align="left" bgcolor="#2A2A2A">
					<input type="radio" name="Period" value="Day" <?php  if ($Period=="Day" || !isset($Period)){ ?>checked="checked" <?php  } ?> > 
					<font face="verdana" size="1" color="#ffffff"><b>SELECCI&Oacute;N DE FECHA</b></font>
				</td>
      			<td align="left" bgcolor="#A2A2A2">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#A2A2A2"><tr><td>
	  				<input type="checkbox" name="fromday" value="true" <?php  if ($fromday){ ?>checked<?php }?>> Desde : 
					...
					<input type="checkbox" name="today" value="true" <?php  if ($today){ ?>checked<?php }?>> Hasta : 
			...
			<tr>
				<td class="bar-search" align="left" bgcolor="#888662">			
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;DESTINO</b></font>
				</td>				
				...
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="dsttype" value="1" <?php if((!isset($dsttype))||($dsttype==1)){?>checked<?php }?>>Exacto</td>
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="dsttype" value="2" <?php if($dsttype==2){?>checked<?php }?>>Comenzando con</td>
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="dsttype" value="3" <?php if($dsttype==3){?>checked<?php }?>>Que contenga</td>
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="dsttype" value="4" <?php if($dsttype==4){?>checked<?php }?>>Terminado en</td>
				</tr></table></td>
			</tr>			
			<tr>
				<td align="left" bgcolor="#2A2A2A">					
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;FUENTE</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#A2A2A2">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#A2A2A2"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="src" value="<?php echo "$src";?>"></td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="srctype" value="1" <?php if((!isset($srctype))||($srctype==1)){?>checked<?php }?>>Exacto</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="srctype" value="2" <?php if($srctype==2){?>checked<?php }?>>Comenzando con</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="srctype" value="3" <?php if($srctype==3){?>checked<?php }?>>Que contenga</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="srctype" value="4" <?php if($srctype==4){?>checked<?php }?>>Terminado en</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#888662">				
				...
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="clidtype" value="1" <?php if((!isset($clidtype))||($clidtype==1)){?>checked<?php }?>>Exacto</td>
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="clidtype" value="2" <?php if($clidtype==2){?>checked<?php }?>>Comenzando con</td>
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="clidtype" value="3" <?php if($clidtype==3){?>checked<?php }?>>Que contenga</td>
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="clidtype" value="4" <?php if($clidtype==4){?>checked<?php }?>>Terminado en</td>
				</tr></table></td>
			</tr>	
            
            <tr>
				<td class="bar-search" align="left" bgcolor="#2A2A2A">				
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;CONTEXTO</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#A2A2A2">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="dcontext" value="<?php echo $dcontext?>"></td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="dcontexttype" value="1" <?php if((!isset($dcontexttype))||($dcontexttype==1)){?>checked<?php }?>>Exacto</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="dcontexttype" value="2" <?php if($dcontexttype==2){?>checked<?php }?>>Comenzando con</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="dcontexttype" value="3" <?php if($dcontexttype==3){?>checked<?php }?>>Que contenga</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="dcontexttype" value="4" <?php if($dcontexttype==4){?>checked<?php }?>>Terminado en</td>
				</tr></table></td>
			</tr>           
			...
			<tr>
				<td class="bar-search" align="left" bgcolor="#2A2A2A">				
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;DURACIÓN</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#A2A2A2">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
			...
			<tr>
        		<td class="bar-search" align="left" bgcolor="#888662"> </td>
...
<!-- ** ** ** ** ** Part to display the CDR ** ** ** ** ** -->
      ...
      <table width="<?php echo $FG_HTML_TABLE_WIDTH?>" border="0" align="center" cellpadding="0" cellspacing="0" style="border: 1px solid #636338">
<TR bgcolor="#ffffff"> 
          <TD bgColor=#989564 height=16 style="PADDING-LEFT: 5px; PADDING-RIGHT: 3px"> 
            <TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
              <TBODY>
                <TR> 
                  <TD width="99%"><SPAN style="COLOR: #ffffff; FONT-SIZE: 11px"><B><?php echo $FG_HTML_TABLE_TITLE?></B></SPAN></TD>
...
<TBODY>
                <TR bgColor=#4F4D0F height="22"> 
				  <TD valign="middle" width="<?php echo $FG_ACTION_SIZE_COLUMN?>" align=center class="tableBodyRight" style="PADDING-BOTTOM: 2px; PADDING-LEFT: 2px; PADDING-RIGHT: 2px; PADDING-TOP: 2px"></TD>					
                  ...
                  <TD valign="middle" width="<?php echo $FG_TABLE_COL[$i][2]?>" align=middle class="tableBody" style="PADDING-BOTTOM: 2px; PADDING-LEFT: 2px; PADDING-RIGHT: 2px; PADDING-TOP: 2px"> 
					...
					echo "&posted=$posted&Period=$Period&frommonth=$frommonth&fromstatsmonth=$fromstatsmonth&tomonth=$tomonth&tostatsmonth=$tostatsmonth&fromday=$fromday&fromstatsday_sday=$fromstatsday_sday&fromstatsmonth_sday=$fromstatsmonth_sday&today=$today&tostatsday_sday=$tostatsday_sday&tostatsmonth_sday=$tostatsmonth_sday&dsttype=$dsttype&srctype=$srctype&clidtype=$clidtype&channel=$channel&resulttype=$resulttype&dst=$dst&src=$src&clid=$clid";?>" style="color: white"> 
				...
				?>
               		 ...
               		 <TR valign="middle" bgcolor="<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$ligne_number%2]?>"  onMouseOver="bgColor='#C4FFD7'" onMouseOut="bgColor='<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$ligne_number%2]?>'"> 
						...
						<?php 	//$FG_TABLE_COL[$i][1];			
				 		 ...
				 		 ?>
                 		 <TD valign="middle" align="<?php echo $FG_TABLE_COL[$i][3]?>" class=tableBody><?php 
						 if (isset ($FG_TABLE_COL[$i][11]) && strlen($FG_TABLE_COL[$i][11])>1){
						 		call_user_func($FG_TABLE_COL[$i][11], $record_display);
						 }else{
							if ( "$i" == "9" & "$recordset[8]" != "0" ) {								
								echo "<embed src='".AUDIO_SOURCE."/".$record_display.".gsm' autostart=false volume='100' style='height: 15px; width: 100px'>";
							}elseif ( "$i" == "9" & "$recordset[8]" == "0" )
								echo "NO AUDIO";
							elseif ( "$i" == "10" & "$recordset[9]" != "0" && "$recordset[8]" != "0" )
                                echo "<a href=\"".AUDIO_SOURCE."/".$record_display.".gsm\"><img src=\"images/icon_down_12x12.GIF\" border=\"0\"></a>";									
							elseif ( "$i" == "10" & "$recordset[9]" != "0" && "$recordset[8]" == "0" )
								echo "--";
							else
        ...
        <TR bgcolor="#ffffff"> 
          <TD bgColor=#B5B88E height=16 style="PADDING-LEFT: 5px; PADDING-RIGHT: 3px"> 
			<TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
              <TBODY>
                <TR> 
                  <TD align="right"><SPAN style="COLOR: #ffffff; FONT-SIZE: 11px"><B> 
					...
					echo "&posted=$posted&Period=$Period&frommonth=$frommonth&fromstatsmonth=$fromstatsmonth&tomonth=$tomonth&tostatsmonth=$tostatsmonth&fromday=$fromday&fromstatsday_sday=$fromstatsday_sday&fromstatsmonth_sday=$fromstatsmonth_sday&today=$today&tostatsday_sday=$tostatsday_sday&tostatsmonth_sday=$tostatsmonth_sday&dsttype=$dsttype&srctype=$srctype&clidtype=$clidtype&channel=$channel&resulttype=$resulttype&dst=$dst&dcontext=$dcontext&src=$src&dstchannel=$dstchannel&clid=$clid&channel=$channel&resulttype=$resulttype&dst=$dst&src=$src&clid=$clid&userfieldtype=$userfieldtype&userfield=$userfield&accountcodetype=$accountcodetype&accountcode=$accountcode&duration1=$duration1&duration1type=$duration1type&duration2=$duration2&duration2type=$duration2type&dcontexttype=$dcontexttype&dstchanneltype=$dstchanneltype";?>"> 
                    Previa </a> - 
                    <?php }?>
					...
					echo "&posted=$posted&Period=$Period&frommonth=$frommonth&fromstatsmonth=$fromstatsmonth&tomonth=$tomonth&tostatsmonth=$tostatsmonth&fromday=$fromday&fromstatsday_sday=$fromstatsday_sday&fromstatsmonth_sday=$fromstatsmonth_sday&today=$today&tostatsday_sday=$tostatsday_sday&tostatsmonth_sday=$tostatsmonth_sday&dsttype=$dsttype&srctype=$srctype&clidtype=$clidtype&channel=$channel&resulttype=$resulttype&dst=$dst&dcontext=$dcontext&dstchannel=$dstchannel&src=$src&clid=$clid&channel=$channel&resulttype=$resulttype&dst=$dst&src=$src&clid=$clid&userfieldtype=$userfieldtype&userfield=$userfield&accountcodetype=$accountcodetype&accountcode=$accountcode&duration1=$duration1&duration1type=$duration1type&duration2=$duration2&duration2type=$duration2type&dcontexttype=$dcontexttype&dstchanneltype=$dstchanneltype";?>"> 
                    Siguiente </a> <img src="images/fleche-d.gif" width="5" height="10"> 
                    </B></SPAN> 
                    <?php }?>
                  </TD>
              </TBODY>
...
<tbody><tr><td bgcolor="#000000">			
	...
	<tr>	
    	...
    	<td bgcolor="#b72222" align="center" colspan="4"><font face="verdana" size="1" color="#ffffff"><b>CONSUMO EN MINUTOS</b></font></td>
    </tr>
	<tr bgcolor="#600101">
		<td align="right" bgcolor="#b72222"><font face="verdana" size="1" color="#ffffff"><b>FECHA</b></font></td>
        <td align="center"><font face="verdana" size="1" color="#ffffff"><b>DURACIÓN</b></font></td>
		<td align="center"><font face="verdana" size="1" color="#ffffff"><b>GRÁFICA</b></font></td>
		<td align="center"><font face="verdana" size="1" color="#ffffff"><b>LLAMADAS</b></font></td>
...
<a href="export_pdf.php" target="_blank"><img src="./images/pdf.gif	" border="0"/></a><br>&nbsp;&nbsp;<a href="export_pdf.php" target="_blank">Exportar a PDF</a>
</td>
<td>
<a href="export_csv.php" target="_blank" ><img src="./images/excel.gif" border="0"/></a><br><a href="export_csv.php" target="_blank">Exportar a CSV</a>
</td></tr></table><br>


<?php  }else{ ?>
	<center><h3>No existen llamadas en su selección.</h3></center>
<?php  } ?>
</center>
