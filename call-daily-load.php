		...
		<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center"  style="border: 1px solid #9D9D59">
			...
			<tr>
				...
				<td class="bar-search" align="center" bgcolor="#E6E8D2">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#E6E8D2">
					 <tr>
						<td align="right">							
...
<tbody><tr><td bgcolor="#000000">			
	...
	<tr bgcolor="#600101">
        ...
        <td align="center"><font face="verdana" size="1" color="#ffffff"><b>DUARACIÓN</b></font></td>
		<td align="center"><font face="verdana" size="1" color="#ffffff"><b>GRAFICO</b></font></td>
...
&nbsp;
<br/>
<!--	<center>Seleccione el intervalo de hora para ver los detalles
	<FORM METHOD=POST ACTION="graph_hourdetail.php?posted=<?php echo $posted?>&min_call=<?php echo $min_call?>&fromstatsday_sday=<?php echo $fromstatsday_sday?>&days_compare=<?php echo $days_compare?>&fromstatsmonth_sday=<?php echo $fromstatsmonth_sday?>&dsttype=<?php echo $dsttype?>&sourcetype=<?php echo $sourcetype?>&clidtype=<?php echo $clidtype?>&channel=<?php echo $channel?>&resulttype=<?php echo $resulttype?>&dst=<?php echo $dst?>&src=<?php echo $src?>&clid=<?php echo $clid?>&userfieldtype=<?php echo $userfieldtype?>&userfield=<?php echo $userfield?>&accountcodetype=<?php echo $accountcodetype?>&accountcode=<?php echo $accountcode?>" target="superframe">		
		<table class="bar-status" width="60%" border="0" cellspacing="1" cellpadding="2" align="center">
			...
			<tr>
			<td align="left" bgcolor="#2A2A2A">					
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;ITERVALO HORARIO :</b></font>
				</td>				
				<td class="bar-search" align="center" bgcolor="#A2A2A2">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;
				<select name="hourinterval">
					<?php 
						for ($i=0;$i<=23;$i++){							
							echo '<option value="'.sprintf("%02d",$i)."\"> Intervalo [".sprintf("%02d",$i).'h to '.sprintf("%02d",$i+1).'h] </option>';
						}
					?>					
					</select>
			...
			<tr>
				<td align="left" bgcolor="#888662">					
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;TIPO DE GRÁFICO :</b></font>
				</td>				
				<td class="bar-search" align="center" bgcolor="#E6E8D2">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;
				<select name="typegraph">
					<option value="fluctuation"> GRAFICA DE FLUCTUACIÓN</option> <option value="watch-call" selected> VER GRÁFICO DE LLAMADAS</option>
				</select>
