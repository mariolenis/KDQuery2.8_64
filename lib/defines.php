...
// WEBROOT es el path en caso de que esté montado en una dirección ip
// fija o Domain
// define ("WEBROOT", "http://190.190.90.190/");
// define ("WEBROOT", "http://dominio.com/");

define ("WEBROOT", "localhost");
define ("FSROOT", "/var/www/htdocs/");

define ("LIBDIR", FSROOT."lib/");

define ("HOST", "localhost");
define ("PORT", "3306");
define ("USER", "kerberus");
define ("PASS", "aster1sk");
define ("DBNAME", "kerberus");
define ("DB_TYPE", "mysql"); // mysql or postgres
define ("DB_TABLENAME", "cdr");
define ("DB_TABLESMS", "usuario");
define ("AUDIO_SOURCE","monitor");
...
include ("lib/DB-modules/phplib_".DB_TYPE.".php");
