...
<!-- ** ** ** ** ** Part for the research ** ** ** ** ** -->
	<center>
	<FORM style="display:inline" METHOD=POST ACTION="<?php echo $PHP_SELF?>?s=<?php echo $s?>&t=<?php echo $t?>&order=<?php echo $order?>&sens=<?php echo $sens?>&current_page=<?php echo $current_page?>">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center"  style="border: 1px solid #9D9D59">
			...
			<tr>
        		<td align="left" bgcolor="#2A2A2A">					
					<font face="verdana" size="1" color="#ffffff">&nbsp;&nbsp;<b>Seleccione el día </b></font>
				</td>
      			<td align="left" bgcolor="#A2A2A2">
					...
					<b>Días de comparación :</b> 
				 	<select name="days_compare">
					<option value="4" <?php if ($days_compare=="4"){ echo "selected";}?>>- 4 Días</option>
					<option value="3" <?php if ($days_compare=="3"){ echo "selected";}?>>- 3 Días</option>
					<option value="2" <?php if (($days_compare=="2")|| !isset($days_compare)){ echo "selected";}?>>- 2 Días</option>
					<option value="1" <?php if ($days_compare=="1"){ echo "selected";}?>>- 1 Días</option>
					</select>
					</td></tr></table>
	  			</td>
    		</tr>	
			...
			<tr>
				...
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="sourcetype" value="1" <?php if((!isset($sourcetype))||($sourcetype==1)){?>checked<?php }?>>Exacto</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="sourcetype" value="2" <?php if($sourcetype==2){?>checked<?php }?>>Comenzando con</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="sourcetype" value="3" <?php if($sourcetype==3){?>checked<?php }?>>Que contenga</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="sourcetype" value="4" <?php if($sourcetype==4){?>checked<?php }?>>Terminado en</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#888662">				
			...
			<!--<tr>
				...
				<td class="bar-search" align="left" bgcolor="#A2A2A2">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#A2A2A2"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="userfield" value="<?php echo "$userfield";?>"></td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="userfieldtype" value="1" <?php if((!isset($userfieldtype))||($userfieldtype==1)){?>checked<?php }?>>Exacto</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="userfieldtype" value="2" <?php if($userfieldtype==2){?>checked<?php }?>>Comenzando con</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="userfieldtype" value="3" <?php if($userfieldtype==3){?>checked<?php }?>>Que contenga</td>
				<td class="bar-search" align="center" bgcolor="#A2A2A2"><input type="radio" NAME="userfieldtype" value="4" <?php if($userfieldtype==4){?>checked<?php }?>>Terminado en</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#888662">				
				...
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="accountcodetype" value="1" <?php if((!isset($accountcodetype))||($accountcodetype==1)){?>checked<?php }?>>Exacto</td>
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="accountcodetype" value="2" <?php if($accountcodetype==2){?>checked<?php }?>>Comenzando con</td>
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="accountcodetype" value="3" <?php if($accountcodetype==3){?>checked<?php }?>>Que contenga</td>
				<td class="bar-search" align="center" bgcolor="#E6E8D2"><input type="radio" NAME="accountcodetype" value="4" <?php if($accountcodetype==4){?>checked<?php }?>>Terminado en</td>
				</tr></table></td>
			</tr>-->			
			<tr>
			<td align="left" bgcolor="#2A2A2A">					
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;CANAL</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#A2A2A2">
				...
				<td class="bar-search" align="center" bgcolor="#E6E8D2">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#E6E8D2"><tr><td>				
						<b>Grafica :</b>
							...
							<option value=1 <?php if ($min_call==1){ echo "selected";}?>>Minutos por horas</option>
							<option value=0 <?php if (($min_call==0) || !isset($min_call)){ echo "selected";}?>>Número de llamadas por horas</option>
							</select>
						</td>
						<td align="right">							
...
<tbody><tr><td bgcolor="#000000">			
	...
	<tr bgcolor="#600101">
        ...
        <td align="center"><font face="verdana" size="1" color="#ffffff"><b>DURACION</b></font></td>
		<td align="center"><font face="verdana" size="1" color="#ffffff"><b>GRAFICA</b></font></td>
