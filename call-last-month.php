		...
		<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" style="border: 1px solid #9D9D59">
			...
			<tr>
        		<td align="left" bgcolor="#2A2A2A">					
					<font face="verdana" size="1" color="#ffffff">&nbsp;&nbsp;<b>Seleccione el Mes</b></font>
				</td>
      			<td align="left" bgcolor="#A2A2A2">
					...
					<option value="1" <?php if ($months_compare=="1"){ echo "selected";}?>>- 1 Mes</option>
					</select>
					</td></tr></table>
	  			</td>
    		</tr>	
...
<?php } ?> <h3>No existen llamadas en su selección.</h3>
<br><br></center>